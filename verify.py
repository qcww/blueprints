...
font = ImageFont.truetype(r'./fonts/ygyxsziti2.0.ttf', 60) # 创建字体对象给ImageDraw中的text函数使用
...
name = ans + '.jpg'
bgImg.save("code_img/"+name, 'jpeg')
#rstImg = Image.open(name)
#rstImg.show()

# inp = raw_input('Please type in the characters in the image:')
# while inp != ans:
#     inp = raw_input('Incorrect input. Please try again:')
